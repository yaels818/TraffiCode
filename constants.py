...
def draw_street_names():
    ...
    STREETS = [ ("HaErez", (LEFT_ROUNDABOUT_CENTER[0]-2*LANE_WIDTH,MAIN_SIDEWALK_TOP_POS-2*LANE_WIDTH)),
                ("HaErez", (MAIN_ROAD_RIGHT_POS,MAIN_SIDEWALK_TOP_POS-LANE_WIDTH)),
                ("HaAlon", (LEFT_ROUNDABOUT_CENTER[0]-2*LANE_WIDTH,MAIN_SIDEWALK_TOP_POS+3*LANE_WIDTH)), 
                ...
                ("HaYaar", (MAIN_ROAD_RIGHT_POS-4*LANE_WIDTH,LEFT_ROUNDABOUT_CENTER[1]-LANE_WIDTH)),
                ...
                ("HaEshel", (TOP_LEFT_SIDEWALK_RIGHT_POS-2*LANE_WIDTH,DASHBOARD_HOR_TOP-4*LANE_WIDTH))]
