...
lights_btn = DashboardButton.DashboardButton(button_images_off[0], button_images_on[0], 0.55, 20, 500)
left_blinker_btn = DashboardButton.DashboardButton(button_images_off[1], button_images_on[1], 0.65, 110, 480)
right_blinker_btn = DashboardButton.DashboardButton(button_images_off[2], button_images_on[2],0.65, 485, 480)
wipers_btn = DashboardButton.DashboardButton(button_images_off[3], button_images_on[3], 0.55, 620, 500)
ac_btn = DashboardButton.DashboardButton(button_images_off[4], button_images_on[4], 0.55, 740, 500)
music_btn = DashboardButton.DashboardButton(button_images_off[5], button_images_on[5], 0.55, 860, 500)
menu_btn = DashboardButton.DashboardButton(menu_btn_img, menu_btn_img, 0.55, 980, 480)
